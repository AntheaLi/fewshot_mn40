...
def CONFIGS():
    ...
    args.add_argument("--LV",action='store_true') # model laplace vector

    args.add_argument("--kways",default=5,type=int)
    args.add_argument("--TrS",default=10,type=int) # train support
    args.add_argument("--TS",default=10,type=int) # test support
    args.add_argument("--TrQ",default=20,type=int) # train query
    args.add_argument("--TQ",default=20,type=int) # test query
    args.add_argument("--TrE",default=4,type=int) # train loop
    args.add_argument("--TE",default=300,type=int) # test loop
